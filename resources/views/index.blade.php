                                    ...
                                    <form action="{{route('create_post')}}" method="post">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group row">
                                                <label for="staticEmail1" class="col-sm-2 col-form-label">Name</label>
                                                <div class="col-sm-10">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea maxlength="10000" rows="7" class="form-control" name="content" style="width: 100%" required></textarea>
                                                </div>
                                            </div>
                                            <br><br>
    ...
    <div class="row">
        <div class="col-12 col-lg-12">
            ...
            <a href="{{route('post.delete', $post->id)}}">
                <button type="button" class="btn btn-danger" onclick="return confirm('Are you sure to delete this?')">Delete
                </button>
            </a>
            @endcan
            <div class="single-blog-area blog-style-2 mb-50 wow fadeInUp pt-2" data-wow-delay="0.3s" data-wow-duration="1000ms">
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="single-blog-content">
                            ...
                            <h4><a href="{{route('show-post', $post->id)}}" class="post-headline">{{$post->name}}</a></h4>
            ...
            @endforeach
            <!-- Single Blog Area  -->
            <div id="content" class="single-blog-area blog-style-2 mb-50 wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1000ms">
            </div>
